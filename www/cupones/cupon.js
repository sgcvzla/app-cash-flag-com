...
function cargaforma() {
	...
	xmlhttp.open("GET", "https://app.cash-flag.com/php/proveedores.php?prov=" + prov, false);
	xmlhttp.send();
...
function enviar() {
	...
	xmlhttp.open("POST", "https://app.cash-flag.com/php/registracupon.php", false);
	xmlhttp.send(datos);
}
...
function buscasocio(valor,opc) {
	...
	if (arroba + punto > 1 && posp > posa) {
		...
		xmlhttp.open("GET", "https://app.cash-flag.com/php/buscasocios.php?email=" + valor, false);
		xmlhttp.send();
...
function buscatitulo() {
	...
	xmlhttp.open("GET", "https://app.cash-flag.com/php/parametros.php", false);
	xmlhttp.send();
}
