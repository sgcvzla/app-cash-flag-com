...
function cargaforma() {
	...
	xmlhttp.open("GET", "https://app.cash-flag.com/php/buscadatos.php?prov=" + prov+"&socio="+socio, false);
	xmlhttp.send();
...
function enviar() {
	...
	xmlhttp.open("POST", "https://app.cash-flag.com/php/registro.php", false);
	xmlhttp.send(datos);
}
