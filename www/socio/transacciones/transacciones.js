...
function inicio() {
	...
	xmlhttp.open("GET", "../https://app.cash-flag.com/php/transac_socio.php?idsocio="+idsocio, true);
	xmlhttp.send();
...
function accion(id) {
	...
	xmlhttp.open("POST", "../https://app.cash-flag.com/php/confirma_transaccion_socio.php", true);
	xmlhttp.send(datos);
}
